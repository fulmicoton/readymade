...
(function() {
  ...
  Server = (function() {
    ...
    Server.prototype.handle = function(request, response) {
      var failure_callback, serve_file, target, url, url_base;
      response.setHeader("Access-Control-Allow-Origin", "*");
      url = request.url;
      console.log('GET ', url);
      url_base = url.split('?', 1)[0];
      target = path.join(this.build_path, url_base);
      ...
      return this.builder.build(target, serve_file, failure_callback);
    };
